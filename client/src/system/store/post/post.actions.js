...
export const deletePostStart = createAction(types.DELETE_POST.START, (payload) => payload);

export const deletePostSuccess = createAction(types.DELETE_POST.SUCCESS, (payload) => payload);

export const deletePostFailure = createAction(types.DELETE_POST.FAILURE, (error) => error);

export const likePostStart = createAction(types.LIKE_POST.START, (payload) => payload);

export const likePostSuccess = createAction(types.LIKE_POST.SUCCESS, (payload) => payload);

export const likePostFailure = createAction(types.LIKE_POST.FAILURE, (error) => error);

export const createCommentStart = createAction(types.CREATE_COMMENT.START, (payload) => payload);

export const createCommentSuccess = createAction(types.CREATE_COMMENT.SUCCESS, (payload) => payload);

export const createCommentFailure = createAction(types.CREATE_COMMENT.FAILURE, (error) => error);

export const fetchUserPostStart = createAction(types.FETCH_USER_POST.START, (payload) => payload);

export const fetchUserPostSuccess = createAction(types.FETCH_USER_POST.SUCCESS, (payload) => payload);

export const fetchUserPostFailure = createAction(types.FETCH_USER_POST.FAILURE, (error) => error);
